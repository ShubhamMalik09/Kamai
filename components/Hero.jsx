  ...
  return (
    <div className='pb-20 px-4'>
        <div className='container mx-auto text-center'>
            ...
            <p className='text-xl text-gray-600 mb-8 max-w-2xl mx-auto'>An AI-powered financial management platform that helps you track, analyse, and optimize your spending with real-time insights</p>
